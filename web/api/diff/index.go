...
const (
	text1 = `The Centers for Disease Control and Prevention (CDC) has begun conducting blood tests it says will help determine if a person has been exposed to the coronavirus, even without showing symptoms, a CDC spokesperson told Politico.
...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	for i := 0; i < 1000; i++ {
		diffs = dmp.DiffMain(text1+strconv.Itoa(i), strconv.Itoa(i)+text1, false)
	}
	var oneDiff = diffs[2]
	js, _ := json.Marshal(oneDiff)
